...
.animated-logo span:nth-child(2) { animation-delay: 0.3s; }
.animated-logo span:nth-child(3) { animation-delay: 0.6s; }
.animated-logo span:nth-child(4) { animation-delay: 0.9s; }
