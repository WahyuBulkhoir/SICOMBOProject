(function($) {
  ...
  $(function() {
    ...
    if ($("#transaction-history").length) {
        var stripeOrders = document.getElementById('transaction-history-data').getAttribute('data-stripe-orders');
        var codOrders = document.getElementById('transaction-history-data').getAttribute('data-cod-orders');   
        var areaData = {
            labels: ["Bayar dengan Rekening (Stripe)", "COD"],
            datasets: [{
                data: [stripeOrders, codOrders],
                backgroundColor: [
                    "#00d25b",
                    "#ffab00"
                ]
